...
export default function SearchStoriesTeaser() {
  return (
    <section id="search-stories" className="scroll-mt-24 py-28 bg-charcoal">
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <StaggerContainer className="border-t border-white/15" stagger={0.08}>
          {SEARCH_STORIES.map((story, i) => (
            <StaggerItem key={story.id}>
              ...
              >
                <span className="text-signal text-xs font-black tracking-[0.2em]">0{i + 1}</span>
                <div>
                  <h3 className="text-lg md:text-xl font-bold text-white leading-tight group-hover:text-signal transition-colors">
                    {story.title}
                  </h3>
        ...
        <div className="mt-12">
          <Link
            ...
            className="inline-block text-white text-sm font-bold tracking-[0.15em] border-b-2 border-signal pb-1 hover:text-signal transition-colors"
          >
