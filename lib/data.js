export const IMAGES = {
  ...
  // Placeholder artwork pending a licensed energy & oilfield photograph.
  energyOilfield: '/markets/energy-oilfield.svg',
};
...
export const MARKETS = [
  ...
  {
    id: 'energy-oilfield',
    title: 'Energy & Oilfield Technologies',
    tagline: 'Talent for the technologies behind oil & gas production.',
    technologies: ['OCTG', 'Drilling', 'Well Construction', 'Completions', 'Intervention', 'Subsea', 'Production'],
    talent: ['Equipment OEMs', 'Service companies', 'Engineering contractors', 'Specialist distributors', 'Operators'],
    appointments: ['Sales Engineer', 'Business Development Manager', 'Applications Engineer', 'Key Account Manager', 'Project Sales Manager', 'Sales Director', 'Commercial Director', 'General Manager'],
    industries: ['Oil & Gas', 'Offshore', 'Subsea', 'Drilling', 'Petrochemical', 'Energy'],
    image: IMAGES.energyOilfield,
    map: {
      direct: ['OCTG', 'Drilling', 'Well Construction', 'Completions', 'Intervention'],
      adjacent: ['Subsea', 'Production', 'Process, Flow & Instrumentation', 'Combustion & Thermal'],
      organisations: ['Equipment OEMs', 'Service Companies', 'Engineering Contractors', 'Specialist Distributors', 'Operators'],
      talent: ['Technical Sales', 'Applications', 'Business Development', 'Key Accounts', 'Commercial Leadership'],
    },
    related: ['process-flow', 'combustion-thermal'],
  },
];
...
export const REGIONS = ['United Kingdom', 'Continental Europe', 'Middle East', 'United States'];
