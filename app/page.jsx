      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <StaggerContainer className="flex items-end justify-between mb-16 flex-wrap gap-4">
            ...
            <StaggerItem>
              <Link href="/insights" className="text-[#3F4143] text-sm font-bold tracking-[0.15em] border-b-2 border-[#FFD91A] pb-1 hover:text-[#FFD91A] transition-colors">
                VIEW ALL INSIGHTS →
              </Link>
            </StaggerItem>
          </StaggerContainer>
          <StaggerContainer className="grid md:grid-cols-3 gap-6" stagger={0.15}>
            {INSIGHTS.slice(0, 3).map((ins) => (
              <StaggerItem key={ins.title}>
                <Link href="/insights" className="group cursor-pointer block p-4 -m-4 rounded hover:bg-[#F7F7F5] transition-colors duration-300">
